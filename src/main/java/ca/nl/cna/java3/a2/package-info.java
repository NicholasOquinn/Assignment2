...
/**
 *
 * 1.	Create a DBConnection class that will handle the details of setting up a database connection.
 * •	The class should have one static method called initDatabase().
 * •	initDatabase requires no parameters
 * •	initDatabase should return a connection object
 * •	Within this class you can use the objects from assignment 1
 *
